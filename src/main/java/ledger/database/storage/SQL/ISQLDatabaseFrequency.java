...
public interface ISQLDatabaseFrequency extends ISQLiteDatabase {
    ...
    default void insertFrequency(Frequency frequency) throws StorageException {
        try {
            ...
            stmt.setString(1, Frequency.convertFrequencyToString(frequency));
            stmt.executeUpdate();
    ...
    default List<Frequency> getAllFrequencies() throws StorageException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Frequency currentFrequency = Frequency.convertStringToFrequency(frequencyName);
    ...
    default Frequency getFrequencyById(int id) throws StorageException {
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery();
            if (rs.next()) {
                toReturn = Frequency.convertStringToFrequency(rs.getString(FrequencyTable.FREQUENCY_NAME));
            }

...
public class AccountBalanceTable {
    ...
    public static final String ABAL_ID = "ABAL_ID";
    public static final String ABAL_ACCOUNT_ID = "ABAL_ACCOUNT_ID";
    public static final String ABAL_DATETIME = "ABAL_DATETIME";
    public static final String ABAL_AMOUNT = "ABAL_AMOUNT";

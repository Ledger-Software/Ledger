...
public class DateAxis extends ValueAxis<Long> {
    ...
    @Override protected void setRange(Object range, boolean animate) {
        ...
        ReadOnlyDoubleWrapper scalePropertyImplValue = (ReadOnlyDoubleWrapper) new ReflectionUtils().forceMethodCall(ValueAxis.class, "scalePropertyImpl", this);
...
//        // pad min and max by 2%, checking if the range is zero
    ...
    public class ReflectionUtils {
        ...
        public Object forceMethodCall(Class classInstance, String methodName, Object source, Class[] paramTypes, Object[] params) {
        ...
        public Object forceMethodCall(Class classInstance, String methodName, Object source, Object... params) {
